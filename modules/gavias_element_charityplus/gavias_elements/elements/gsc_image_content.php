...
if(!class_exists('gsc_image_content')):
   class gsc_image_content{
           ...
           'type'          => 'gsc_image_content',
            ...
            'fields' => array(
               ...
               array(
                  'id'        => 'text_link',
                  'type'      => 'text',
                  'title'     => t('Text Link (use for skin #1)'),
               ),
      ...
      public static function sc_image_content( $attr, $content = null ){
               ...
               <div class="content">
                  <?php if($title){ ?><h4 class="title">
                     <?php if($link){ ?><a <?php print $target ?> href="<?php print $link ?>"><?php } ?>
                        <?php if($icon){ print "<span class=\"{$icon}\"></span>"; } ?><?php print $title ?>
                     <?php if($link){ ?></a><?php } ?>  
                  </h4><?php } ?>   
         ...
         ?>
            <div class="gsc-image-content <?php print $el_class; ?>" <?php print gavias_print_animate_aos($animate) ?>>
               <div class="bg-color" <?php print $style_bg ?>></div>
               <div class="image"><?php if($link){ ?><a <?php print $target ?> href="<?php print $link ?>"><?php } ?><img src="<?php print $background ?>" alt="<?php print $title ?>" /><?php if($link){ ?></a><?php } ?></div>
               <div class="content">
                  <?php if($icon){ print "<div class=\"icon\"><span class=\"{$icon}\"></span></div>"; } ?>
                  <?php if($title){ ?><h4 class="title">
                     <?php if($link){ ?><a <?php print $target ?> href="<?php print $link ?>"><?php } ?><?php print $title ?><?php if($link){ ?></a><?php } ?>  
                  </h4><?php } ?>   
                  <div class="desc"><?php print $content; ?></div>
               </div>  
            </div>
