...
if(!class_exists('gsc_our_team')):
   class gsc_our_team{
      ...
      public static function sc_our_team( $attr, $content = null ){
         ...
         if($style=='vertical'){ ?>
            <div class="widget gsc-team team-vertical <?php print $el_class ?>" <?php print gavias_print_animate_aos($animate) ?>>
         ...
         //circle
         if($style=='circle'){ ?>
            <div class="widget gsc-team team-vertical team-circle <?php print $el_class ?>" <?php print gavias_print_animate_aos($animate) ?>>
               <div class="widget-content text-center">
                  <div class="team-header text-center">
                     <img alt="<?php print $title ?>" src="<?php print $image ?>" class="img-responsive"> 
                     <div class="box-hover">
