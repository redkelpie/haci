   ...
   class gsc_tabs{
      ...
      public static function render_tabs( $attr, $content = null ){
         ...
         $uid = 'uid-' . gavias_blockbuilder_makeid();
          ...
          ob_start() ?>
         <div class="gsc-tabs <?php print $el_class ?>" <?php print gavias_print_animate_aos($animate) ?>>
            <div class="tabs_wrapper tabs_<?php print $type ?>">
               ...
               <div class="tab-content">
                  <?php for($i=1; $i<=8; $i++){ ?>
                     ...
                     ?>
                     <?php if($$title){ ?>
                        <div id="<?php print($uid .'-'. $i) ?>" class="tab-pane fade in <?php print($i==1?'active':'') ?>"><?php print do_shortcode( $$content ) ?></div>
                     <?php } ?>
                  <?php } ?>
               </div>
            </div>
